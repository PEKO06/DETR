...
class resnet:
    ...
    def build_net_18(self):
        ...
        self.layer2 = self.resnet_block(self.layer1,self.ch,2,stride=1,scope='layer2')
        self.layer3 = self.resnet_block(self.layer2,self.ch*2,2,stride=2,scope='layer3')
        self.layer4 = self.resnet_block(self.layer3,self.ch*4,2,stride=2,scope='layer4')
        self.layer5 = self.resnet_block(self.layer4,self.ch*8,2,stride=2,scope='layer5')
